...
<div id="container" class="first">
    <div class="container second ">
        <pre style="font-size: 20px"> Home > <a class="urllink" href="<%=request.getContextPath()%>/portal#standard">Standards</a> > <a class="urllink" href="<%=request.getContextPath()%>/portal/intstandard"> Integration Standards </a> > ${servicetype} Services</pre>
                ...
                <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 a">
                    <div class="main-box-div " style="background-color: white">
                        ...
                        <div class="col-xs-7-new left  ">
                            ...
                            <a href="<%=request.getContextPath()%>/portal/serviceislist/${data.id}">
