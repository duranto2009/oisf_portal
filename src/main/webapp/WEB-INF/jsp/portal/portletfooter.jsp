                        ...
                        <div class="col-md-6">
                            <ul class=" text-left">
                                ...
                                <a href="http://www.cabinet.gov.bd/">
                                    <li class="roboto fw-300" style="font-size: 14px;list-style-type: none;">Cabinet Division</li>
                                </a>
                                <a href="http://www.ptd.gov.bd/">
                                    <li class="roboto fw-300" style="font-size: 14px;list-style-type: none;"> Ministry of Post, Telecommunication and Information Technology </li>
                                </a>
                                <a href="http://a2i.pmo.gov.bd/">
                                    <li class="roboto fw-300" style="font-size: 14px;list-style-type: none;">a2i Programme</li>
                                </a>
                                <a href="http://doptor.gov.bd">
                                    <li class="roboto fw-300" style="font-size: 14px;list-style-type: none;">Doptor Login</li>
                                </a>
                            </ul>
                        </div>
...
<script src="/assets/js/portal/bootstrap.min.js"></script>
<script src="/assets/js/portal/bootstrap.bundle.min.js"></script>
